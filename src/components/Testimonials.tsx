      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <button
            ...
            className="hidden md:block absolute left-0 top-1/2 -translate-y-1/2 md:-translate-x-12 p-2 rounded-full bg-white/10 text-white hover:bg-white/20 transition-all duration-300 z-10"
          ...
          <button
            onClick={handleNext}
            className="hidden md:block absolute right-0 top-1/2 -translate-y-1/2 md:translate-x-12 p-2 rounded-full bg-white/10 text-white hover:bg-white/20 transition-all duration-300 z-10"
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="group glass-effect p-6 sm:p-8 rounded-2xl relative animate-slide-up hover:bg-white/20 transition-colors duration-300">
                    <Quote className="absolute top-4 right-4 text-blue-400 transform transition-transform duration-300 group-hover:rotate-12" size={24} />
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        <h3 className="font-semibold text-base sm:text-lg group-hover:text-blue-300 transition-colors duration-300">
                          {testimonial.name}
                        </h3>
                        <p className="text-sm sm:text-base text-blue-200/80">{testimonial.role}</p>
                      </div>
                    </div>
